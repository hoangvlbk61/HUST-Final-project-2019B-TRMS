...
mutation editMedication($medicationId: Int!, $medicationInfo: MedicationGrapheneObjInput!) {
    editMedication(medicationId: $medicationId, medicationInfo: $medicationInfo) {
      ok
      medication{
        name
        quantity
